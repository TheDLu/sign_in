...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { email: @resident.email, name: @resident.name, phone_number: @resident.phone_number }
    end
  ...
  test "should update resident" do
    patch :update, id: @resident, resident: { email: @resident.email, name: @resident.name, phone_number: @resident.phone_number }
    assert_redirected_to resident_path(assigns(:resident))
  end
